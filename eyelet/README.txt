The "Eyelet" Moodle Theme
======================
Eyelet is a basic child theme of Shoelace to help you as a theme developer create your own child theme of Shoelace.

Eyelet is provided 'AS IS' so that you may learn from it and use it as the starting point of your child.  If you want to change
the name of this theme, then follow the standard procedure for cloning a theme: https://docs.moodle.org/dev/Cloning_a_theme.

You MUST have 'Shoelace' installed for this child theme to work.  The 'version.php' file contains the correct 'required' dependent
version of 'Shoelace'.
...
Free Software
=============
The Eyelet theme is 'free' software under the terms of the GNU GPLv3 License, please see 'COPYING.txt'.

It is a child theme within 'Shoelace' - folder 'Eyelet' can be obtained for free from:
http://moodle.org/plugins/view.php?plugin=theme_Shoelace
and
...
============
 ...
 3. Copy the 'Eyelet' folder to the '/theme/' folder.
...
=========
 1. Ensure you have the version of Moodle as stated above in 'Required version of Moodle'.  This is essential as the
    theme relies on underlying core code that is out of my control.
 2. Login as an administrator and put Moodle in 'Maintenance Mode' so that there are no users using it bar you as the administrator.
 3. Make a backup of your old 'Eyelet' folder in '/theme/' and then delete the folder.
 4. Copy the replacement extracted 'Eyelet' folder to the '/theme/' folder.
...
==============
 ...
 3. In '/theme/' remove the folder 'Eyelet'.
...
4.  In '/theme/' remove the folder 'Eyelet' i.e. ALL of the contents - this is VITAL.
5.  Put in the replacement 'Eyelet' folder into '/theme/'.
6.  In the database, remove the row with the 'plugin' of 'theme_Eyelet' and 'name' of 'version' in the 'config_plugins' table, then
...
8.  Switch the theme back to 'Eyelet' under 'Home -> Administration -> Site administration -> Appearance -> Themes -> Theme selector ->
    Default'.
