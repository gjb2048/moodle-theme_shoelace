...
$hasfooter = (empty($PAGE->layout_options['noblocks']) && $PAGE->blocks->region_has_content('footer', $OUTPUT));
$contentclass = 'span8';
$blockclass = 'span4';
...
<div id="page" class="container-fluid">
	...
	<div class="row-fluid">
    		<div id="footer-blocks" class="block-region">
    			<div class="region-content">
       			<?php if ($hasfooter) {
            		echo $OUTPUT->shoelaceblocks('footer', 'span12', 'aside', true);
        		} ?>
        		</div>
        	</div>
    	</div>
